    ...
    <div className="min-h-screen bg-[#F8EDED] font-sans text-[#6B5A59] pb-20 selection:bg-[#E6D5D5] selection:text-[#6B5A59]">
      ...
      <div className="flex justify-center pt-10 pb-6">
        <div className="w-28 h-28 rounded-full overflow-hidden shadow-sm border-4 border-white bg-white">
          {/* 🚨 請確保 178188145100086430.jpg 放在專案的 public 資料夾中！ */}
          <img 
      ...
      <div className="max-w-3xl mx-auto px-4 mb-6">
        <div className="flex justify-center gap-8 border-b border-[#E6D5D5]">
          <button 
            onClick={() => setActiveTab('detail')}
            className={`pb-3 px-2 text-[17px] font-bold flex items-center gap-1.5 transition-colors relative ${
              activeTab === 'detail' ? 'text-[#6B5A59]' : 'text-[#B09F9E] hover:text-[#8C7A79]'
            }`}
          >
            🔎 方案詳情
            {activeTab === 'detail' && (
          ...
          <button 
            ...
            className={`pb-3 px-2 text-[17px] font-bold flex items-center gap-1.5 transition-colors relative ${
              activeTab === 'gallery' ? 'text-[#6B5A59]' : 'text-[#B09F9E] hover:text-[#8C7A79]'
            }`}
          >
            🤍 卡紙範例圖
            {activeTab === 'gallery' && (
      ...
      <main className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-[2rem] p-6 sm:p-10 shadow-sm border border-[#F0E4E4]">
          ...
          {activeTab === 'detail' && (
            <>
              ...
              {/* =========================================
                  1. 純批發區塊 
              ========================================== */}
              <div className="mb-10 border-b border-[#F0E4E4] pb-10">
                <h3 className="text-[20px] font-bold text-[#6B5A59] mb-4">純批發</h3>
                <div className="text-[15px] leading-relaxed text-[#6B5A59] space-y-4 mb-6">
                  <div>
          ...
          {activeTab === 'gallery' && (
            <div className="text-center py-20 text-[#8C7A79]">
              {/* 這裡保留給未來的圖片展示區 */}
